...
const sajuResult = {
    title: "갑술 (푸른 개)",
    user_name: "홍길동",
    birth_info: "1994-05-31 | 양력 | 13:35 | 남성",
...
const sajuExplains = [
    {
        title: "샘물 위로 새순이 말을 걸고, 마음은 밤에야 자리를 찾는구나",
        content: `
...
`
    ...
    {
        title: "말끝은 부드러우나 속도는 날카로워, 기준은 흔들림 없구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "배운 것을 가볍게 엮으니, 사람들 앞에서 더 또렷해지는구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "은근한 눈길과 단정한 태도로 마음의 깊이가 보이는구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "지출은 들쭉날쭉해도 손에 남으니, 절약이 먼저이구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "약속과 책임을 중히 여기니, 맡은 자리를 오래 지키겠구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "겉웃음 뒤 선이 선명하니, 쉽게 다가오나 잊히지 않는구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
`
    ...
    {
        title: "생각은 빠르고 손은 바쁘니, 차근차근 쌓아야 빛나는구나",
        content: `
님은 어릴 적부터 겉으로 넘기고 안에서 다시 살피는 버릇이 있었을 겁니다.
말을 바로 세우기보다 먼저 참고, 혼자서 답을 다시 맞춰 보는 쪽에 가까웠습니다.
지금도 사람 앞에서는 웃으며 받지만, 집에 오면 그날 대화를 여러 번 되짚습니다.
...
function renderExplains() {
    ...
    card.innerHTML = `
        ...
        상황을 살피고 여러 가능성을 헤아린 뒤 방향을 정하는 기운이 강해서 
        결단이 늦어 보일 수 있지만, 한 번 뜻을 세우면 끝까지 붙들 수 있는 끈기를 지녔네. 
        자네의 재능은 처음부터 화려하게 드러나기보다 경험이 쌓일수록 선명해질 것이다. 
        직접 부딪히고 실패하며 자신만의 방식을 만들어 가는 사람이므로, 
    ...
    <div class="result_extit">
        ...
        마음이 깊은 만큼 생각도 많은 사람이라, 
        속으로는 수많은 경우의 수를 헤아리며 자신을 무겁게 만들 수도 있지. 
        감정을 드러내지 않지만 한 번 마음 안에 들어온 것은 오랫동안 기억하며, 
        천천히 신뢰를 쌓은 몇 사람과 깊은 관계를 맺으려 할 것이네.
